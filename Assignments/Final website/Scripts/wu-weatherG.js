        ...
        weatherObject.open('GET','https://api.wunderground.com/api/c5c195880be05e28/conditions/q/SC/Greenville.json',true);
        weatherObject.send();
        ...
        var castObject= new XMLHttpRequest();
            ...
            castObject.open('GET','https://api.wunderground.com/api/c5c195880be05e28/forecast/q/SC/Greenville.json',true);
            castObject.send();
