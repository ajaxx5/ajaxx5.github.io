        ...
        weatherObject.open('GET','https://api.wunderground.com/api/c5c195880be05e28/conditions/q/MN/Franklin.json',true);
        weatherObject.send();
        ...
        var castObject= new XMLHttpRequest();
            ...
            castObject.open('GET','https://api.wunderground.com/api/c5c195880be05e28/forecast/q/MN/Franklin.json',true);
            castObject.send();
